      ...
      try {
        ...
        for (int c = 0; c < courses.length(); ++c) {
          ...
          if (!course.isNull("testDates")) {
            ...
            A = Optional.of(new CourseObject.ExamDate(Integer.valueOf(td.getInt("day")), Integer.valueOf(td.getInt("month")), Integer.valueOf(td.getInt("year"))));
            try {
              td = testDates.getJSONObject(1);
              B = Optional.of(new CourseObject.ExamDate(Integer.valueOf(td.getInt("day")), Integer.valueOf(td.getInt("month")), Integer.valueOf(td.getInt("year"))));
