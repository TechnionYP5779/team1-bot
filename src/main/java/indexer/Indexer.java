...
public class Indexer {
	...
	void BooleanRetrieval(String queryFile) {
		try(BufferedReader br = new BufferedReader(new FileReader(new File(queryFile)))) {
			String line;
			while ((line = br.readLine()) != null)
				System.out.println(printPostingList(queryParsing(line)));
